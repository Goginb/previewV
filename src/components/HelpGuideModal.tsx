...
const SECTIONS: { title: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      '\\ или кнопка Grid align — разложить плитки без наложений (если есть выделение — только выделенное)',
      'B — создать backdrop (контейнер) под курсором',
      'Ctrl+N — новая заметка · F3 — кадр из видео · F4 — рисование по выбранному изображению',
      'Ctrl+Shift+A — переключить «окно поверх всех» (always on top)',
    ],
  },
]
