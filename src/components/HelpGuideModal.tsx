...
const SECTIONS: { title: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Масштаб: Ctrl + колесо мыши или жесты тачпада; также можно зажать правую кнопку и двигать мышь вверх/вниз (наезд/отъезд), как в некоторых 3D-вьюверах. Короткий клик ПКМ по-прежнему открывает контекстное меню.',
  ...
  },
  {
    ...
    body: [
      ...
      'Клавиша Q открывает окно с путём к текущему проекту. Если проект ещё не сохранён, открывается пустое поле.',
    ],
  },
  {
    title: 'Заметки',
  ...
  },
  {
    ...
    body: [
      ...
      'Лёгкие H.264-прокси для ProRes и MJPEG-in-MOV сохраняются в папку Prores_proxy_temp рядом с файлом проекта (если проект сохранён) или на рабочем столе. Имя файла: как у исходника с припиской _proxy_ и коротким идентификатором, например Shot_010_proxy_a1b2c3d4.mp4.',
    ],
  },
  {
    title: 'Бэкдропы',
  ...
  },
  {
    ...
    body: [
      ...
      'Ctrl+B — открыть папку с видео-прокси (Prores_proxy_temp)',
      'B — создать backdrop',
      'N — создать заметку',
      'Q — показать путь к текущему проекту',
      ...
      'F11 — полноэкранный режим (только холст); повторное F11 или Esc — выход',
    ],
  },
]
